...
// if($server=='localhost'){
// 	$http = 'http';
// 	$server = 'localhost/basiyn_api';
// }
// $config['base_url']	= $http.'://'.$server.'/';
// $config['assets']	= $http.'://'.$server.'/theme/';
// $config['base_image_url'] = "https://s3.amazonaws.com/basiyndev/";
$config['API_ENV'] = FALSE;
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
